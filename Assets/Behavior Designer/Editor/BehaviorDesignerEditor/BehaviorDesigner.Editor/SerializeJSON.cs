...
namespace BehaviorDesigner.Editor
{
	public class SerializeJSON : UnityEngine.Object
	{
		...
		public static void Save(BehaviorSource behaviorSource)
		{
			...
			SerializeJSON.taskSerializationData.JSONSerialization = MiniJSON.Json.Serialize(dictionary);
		...
		public static void Save(GlobalVariables variables)
		{
			...
			SerializeJSON.variableSerializationData.JSONSerialization = MiniJSON.Json.Serialize(dictionary);
