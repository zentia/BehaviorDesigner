...
namespace BehaviorDesigner.Editor
{
	public class TaskCopier : UnityEditor.Editor
	{
		public static TaskSerializer CopySerialized(Task task)
		{
			...
			taskSerializer.serialization = MiniJSON.Json.Serialize(SerializeJSON.SerializeTask(task, false, ref taskSerializer.unityObjects));
		...
		public static Task PasteTask(BehaviorSource behaviorSource, TaskSerializer serializer)
		{
			...
			return DeserializeJSON.DeserializeTask(behaviorSource, MiniJSON.Json.Deserialize(serializer.serialization) as Dictionary<string, object>, ref dictionary, serializer.unityObjects);
		}
	}
}
